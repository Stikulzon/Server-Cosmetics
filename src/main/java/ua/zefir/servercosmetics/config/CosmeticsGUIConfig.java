...
public class CosmeticsGUIConfig extends AbstractGuiConfig {
  ...
  @Getter private static PolymerModelData paintItemPolymerModelData;
  ...
  protected void addDefaultButtons(ConfigurationSection buttonsSection) {
    ...
    buttonDefaults.put(
        "filter.chestplate-cosmetics-disabled",
        Map.of(
            "name",
            ...
            List.of()));
    buttonDefaults.put(
        "filter.chestplate-cosmetics-enabled",
        Map.of(
            "name",
            "<blue>Chestplate Cosmetics",
            "item",
    ...
    buttonDefaults.put(
        "filter.leggings-cosmetics-disabled",
        Map.of(
            "name",
            "<blue>Leggings Cosmetics",
            "item",
            ...
            List.of()));
    buttonDefaults.put(
        "filter.leggings-cosmetics-enabled",
        Map.of(
            "name",
            "<blue>Leggings Cosmetics",
            "item",
    ...
    buttonDefaults.put(
        "filter.boots-cosmetics-disabled",
        Map.of(
            "name",
            "<blue>Boots Cosmetics",
            "item",
            ...
            List.of()));
    buttonDefaults.put(
        "filter.boots-cosmetics-enabled",
        Map.of(
            "name",
            "<blue>Boots Cosmetics",
            "item",

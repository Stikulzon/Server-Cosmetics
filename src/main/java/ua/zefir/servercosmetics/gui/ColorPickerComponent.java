  ...
  private static class ColorPickerScreen extends SimpleGui {
    ...
    public void drawBaseColorSlots() {
      ...
      if (usePaintBrushView.getValue()
          && CosmeticsGUIConfig.getPaintItemPolymerModelData() != null) {
        templateStack = new ItemStack(Items.LEATHER_HORSE_ARMOR);
        templateStack.set(
            DataComponentTypes.CUSTOM_MODEL_DATA,
            new CustomModelDataComponent(
                CosmeticsGUIConfig.getPaintItemPolymerModelData().value()));
      } else {
      ...
      for (int i = 0; i < baseColorDisplaySlots.length && i < colorHexValues.length; i++) {
        ...
        try {
          ...
          displayColorStack.set(
              DataComponentTypes.DYED_COLOR, new DyedColorComponent(decimalColor, true));
                ...
                .setCallback(
                    () -> {
                      ...
                      finalColoredHat.set(
                          ...
                          new DyedColorComponent(stepColorRgb, true));
  ...
  private static class ColorInputSign extends SignGui {
    ...
    public void onClose() {
      ...
      try {
        ...
        coloredStack.set(
            DataComponentTypes.DYED_COLOR, new DyedColorComponent(color.getRGB(), true));
